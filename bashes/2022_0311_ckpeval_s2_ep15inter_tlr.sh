...
--run_name cosmask_t2s2_ep15_intertinylr --batch_size 384 --dataset cifar100 --epochs 50 --dis_or_interact interact \
--ft_folder Interact_MAE/mae_vit_base_patch16_smallde/cosmask_t2s2_ep15_tinylr