...
--run_name cos_mask_SDE400_BDE160 --batch_size 256 --dataset imagenet --epochs 50 \
--teach_ckp Interact_MAE/mae_vit_base_patch16_smallde/offi_4GPU_smallDE400/checkpoint-399.pth \
--stud_ckp Interact_MAE/mae_vit_base_patch16_smallde/offi_4GPU160/checkpoint-159.pth