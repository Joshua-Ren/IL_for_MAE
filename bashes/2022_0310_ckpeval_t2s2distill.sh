...
--run_name cosmask_t2s2_distill --batch_size 384 --dataset cifar100 --epochs 50 --dis_or_interact distill \
--ft_folder Distill-IN1K/mae_vit_base_patch16_smallde/cosmask_t2s2