...
--run_name cosmaskSDE400_BDE160_15_tinylr --batch_size 384 --epochs 90 --de_epochs 5 --enlr_ratio 0.5 --blr 1e-4 \
--en_ckp Distill-IN1K/mae_vit_base_patch16_smallde/cos_mask_SDE400_BDE160/checkpoint-15.pth