...
--run_name cosmask_t2s2 --batch_size 256 --dataset imagenet --epochs 50 \
--teach_ckp Interact_MAE/mae_vit_base_patch16_smallde/cosmaskSDE400_BDE160_15_tinylr/checkpoint-80.pth \
--stud_ckp Interact_MAE/mae_vit_base_patch16_smallde/offi_4GPU_smallDE400/checkpoint-399.pth