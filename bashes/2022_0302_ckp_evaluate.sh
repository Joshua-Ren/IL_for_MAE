...
--run_name int400_cosmaskdis49_interact95 --batch_size 384 --dataset cifar100 --epochs 50 \
--ft_folder Interact_MAE/mae_vit_base_patch16_smallde/int400_maskdis49_int95_senlr