...
--run_name nil_int400_dis50_int95_start --batch_size 384 --dataset cifar100 --epochs 100 \
--finetune Interact_MAE/mae_vit_base_patch16_smallde/int400_dis50_int95/checkpoint-0.pth